...
- 업로드 QA를 13개 케이스로 확대하고 health, finance, HR/customer, facility/safety, manufacturing, invalid, text-like, non-predictive ID 목록을 검증.
- ID/이름/주소 위주의 비예측형 CSV는 운영 API에서도 거부되도록 보강.
...
5. 새 기능 추가는 발표 후 11월 로드맵으로 복귀한 뒤 진행한다.
