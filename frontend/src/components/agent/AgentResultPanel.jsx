  ...
  return (
    <div style={{ display: 'grid', gap: 16 }}>
      ...
      <div className="card">
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 14, alignItems: 'center', marginBottom: 14 }}>
          <div>
            ...
            <h2 style={{ fontSize: 18, color: 'var(--text)', margin: 0 }}>자동 분석 실행 기록</h2>
          </div>
          <Badge variant={result.demo_mode ? 'secondary' : 'default'}>{result.demo_mode ? '기본 요약' : '설명 사용'}</Badge>
        </div>
      ...
      <div className="card" style={{ display: 'flex', justifyContent: 'space-between', gap: 16, alignItems: 'center' }}>
        <div>
          <h2 style={{ fontSize: 18, color: 'var(--text)', margin: '0 0 6px' }}>분석 결론이 준비되었습니다</h2>
